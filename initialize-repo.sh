...
echo
echo Continue to create GitHub TAP GitOps Repo aks-itn-1
echo     https://github.com/where4dinner/aks-itn-1
echo
...
git add .
git commit -am "."
gh repo create aks-itn-1 --private
git remote add origin https://github.com/where4dinner/aks-itn-1
git branch -M main
